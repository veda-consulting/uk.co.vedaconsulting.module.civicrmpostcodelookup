...
function _civicrmpostcodelookup_civix_civicrm_managed(&$entities) {
  ...
  foreach ($mgdFiles as $file) {
    ...
    foreach ($es as $e) {
      if (empty($e['module'])) {
        $e['module'] = 'uk.co.vedaconsulting.module.civicrmpostcodelookup';
      }
      $entities[] = $e;
    }
  }
...
function _civicrmpostcodelookup_civix_civicrm_caseTypes(&$caseTypes) {
  ...
  foreach (_civicrmpostcodelookup_civix_glob(__DIR__ . '/xml/case/*.xml') as $file) {
    ...
    $caseTypes[$name] = array(
      'module' => 'uk.co.vedaconsulting.module.civicrmpostcodelookup',
      'name' => $name,
      'file' => $file,
    );
  }
 ...
 */
function _civicrmpostcodelookup_civix_insert_navigation_menu(&$menu, $path, $item, $parentId = NULL) {
  static $navId;
